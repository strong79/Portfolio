    ...
    >
      ...
      >
        <div className="text-center mb-4">
          <h3 className="text-lg font-semibold text-gray-300 mb-2">{t.contact.connectTitle}</h3>
        ...
        <ul className="space-y-2 mb-6 text-center">
          {t.contact.connectTopics.map((topic) => (
      ...
      >
        <p className="text-gray-400 text-xs mb-2 font-semibold uppercase tracking-wide">{t.contact.status.label}</p>
        <div className="flex items-center justify-center gap-2">
          <span className="text-lg" aria-hidden="true">🟢</span>
          <span className="text-green font-semibold text-sm">{t.contact.status.available}</span>
        </div>
      </motion.div>
